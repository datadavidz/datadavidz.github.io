...
```
## Summary
The regularized linear model had relatively poor predictive performance (RMSE = 11.4 MPa, R^2^ = 0.62).  A non-linear, least squares model will be built with improved perfomance in the next post.
